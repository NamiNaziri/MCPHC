...
if __name__ == "__main__":
    ...
    test_command = f"python triton/{args.experiment}/phc/train.py task=HumanoidAeMcpPnn6 task.env.numEnvs=1 headless=True test=True train.params.config.minibatch_size=1 checkpoint=runs/{args.experiment}/nn/{args.checkpoint} +debug1={args.debug1} train.params.config.player.games_num=1 +pythonpath={args.experiment} task.env.episodeLength=1500"
    # command_list = [
