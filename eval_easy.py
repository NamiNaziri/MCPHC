...
if __name__ == "__main__":
    ...
    test_command = f"python triton/{args.experiment}/phc/train.py task=HumanoidAeMcpPnn6 task.env.numEnvs=1 headless=False test=True train.params.config.minibatch_size=1 checkpoint=/home/naminaziri/scratch/AGit/MCPHC/runs/{args.experiment}/nn/HumanoidAeMcpPnn6PPO.pth +debug1={args.debug1} +pythonpath={args.experiment}"
