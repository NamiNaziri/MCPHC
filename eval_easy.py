...
if __name__ == "__main__":
    ...
    test_command = f"python triton/{args.experiment}/phc/train.py task=HumanoidAeMcpPnn6 task.env.numEnvs=2 headless=False test=True train.params.config.minibatch_size=2 checkpoint=runs/{args.experiment}/nn/{args.checkpoint}.pth +debug1={args.debug1} +pythonpath={args.experiment} task.env.episodeLength=1500"
