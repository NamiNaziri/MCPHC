...
if __name__ == "__main__":
    ...
    test_command = f'python triton/{args.experiment}/phc/train.py task=HumanoidAeMcpPnn6 task.env.numEnvs=2 headless=False test=False train.params.config.minibatch_size=2 +debug1={args.debug1} +pythonpath={args.experiment}'
